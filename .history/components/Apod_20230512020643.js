...
function Apod() {
  ...
  return (
    <div className="flex justify-center">
        <div className="w-1/3">
            <input className="w-full text-center" onchange="this.style.textAlign='center'" type="date" value={selectedDate.toISOString().substr(0, 10)} onChange={handleDateChange} />
        </div>
      {apodData ? (
        <div>
