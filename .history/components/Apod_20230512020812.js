  ...
  return (
    <div className="flex justify-center">
        <div className="bg-white rounded-lg p-4">
            <input className="block mx-auto text-center" onchange="this.style.textAlign='center'" type="date" value={selectedDate.toISOString().substr(0, 10)} onChange={handleDateChange} />
        </div>
      {apodData ? (
        <div>
